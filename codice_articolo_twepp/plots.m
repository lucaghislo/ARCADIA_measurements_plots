...
% Mean and sigma over all TPs at 20°C and VDD = 1.2V
...
% read data
for tp = [1:n_tps]
    data = readtable("C:\Users\ghisl\Documents\GitHub\ARCADIA_measurements_plots\output\Vout\data\Vout_TP" + string(tp) + "_temp.dat");
    vouts(tp, 1) = data.Var2(data.Var1 == temperature);
end
